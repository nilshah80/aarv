module github.com/nilshah80/aarv/codec/benchmarks
...
replace (
	github.com/nilshah80/aarv/codec/jsonv2 => ../jsonv2
	github.com/nilshah80/aarv/codec/segmentio => ../segmentio
	github.com/nilshah80/aarv/codec/sonic => ../sonic
)
